...
const schema = z.object({
    ...
    nombre: z.string().trim()
        .min(2, "Al menos debe tener dps letras")
        .max(8, "Como máximo debe haber 8 letras"),
    edad: z.coerce.number()
        .min(12, "La edad mínima debe ser 12 años")
        .max(100, "La edad máxima debe ser 100 años"),
    telefono: z.string().trim()
        .regex(/[678]{1}[0-9]{8}/, "Escribe 9 dígitos, siendo el primero 6,7 u 8"),
    email: z.string().email({ message: "Email no válido" }),
    fecha: z.coerce.date()
        .min(new Date("2000-01-01"), "La fecha debe estar dentro del año 2000")
        .max(new Date("2025-13-01"), "La fecha debe estar dentro del año 2025"),
